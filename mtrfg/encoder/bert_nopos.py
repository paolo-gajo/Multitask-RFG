...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if attention_mask is not None:
            # Apply the attention mask is (precomputed for all layers in BertModelNoPos forward() function)
...
class BertModelNoPos(BertPreTrainedModel):
    """
...
class BertForPreTraining(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.bert = BertModelNoPos(config)
...
class BertLMHeadModel(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.bert = BertModelNoPos(config, add_pooling_layer=False)
